...
--
-- Хост: localhost
-- Время создания: Окт 22 2013 г., 07:53
...
--
-- Структура таблицы `aic0r_assets`
--

CREATE TABLE IF NOT EXISTS `aic0r_assets` (
...
--
-- Дамп данных таблицы `aic0r_assets`
--

INSERT INTO `aic0r_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 8, 20, 27, 2, 'com_content.category.8', 'Категория 1', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(36, 8, 28, 31, 2, 'com_content.category.9', 'Категория 2', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(37, 8, 32, 35, 2, 'com_content.category.10', 'Категория 3', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(38, 35, 21, 22, 3, 'com_content.article.1', 'текст1', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(39, 35, 23, 24, 3, 'com_content.article.2', 'текст2', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(40, 36, 29, 30, 3, 'com_content.article.3', 'текст3', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(41, 37, 33, 34, 3, 'com_content.article.4', 'текст4', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(42, 35, 25, 26, 3, 'com_content.article.5', 'trsrdst', '');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_associations`
--

CREATE TABLE IF NOT EXISTS `aic0r_associations` (
...
--
-- Структура таблицы `aic0r_banners`
--

CREATE TABLE IF NOT EXISTS `aic0r_banners` (
...
--
-- Структура таблицы `aic0r_banner_clients`
--

CREATE TABLE IF NOT EXISTS `aic0r_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `aic0r_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `aic0r_banner_tracks` (
...
--
-- Структура таблицы `aic0r_categories`
--

CREATE TABLE IF NOT EXISTS `aic0r_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `aic0r_categories`
--

INSERT INTO `aic0r_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(8, 35, 1, 13, 14, 1, 'kategoriya-1', 'com_content', 'Категория 1', 'kategoriya-1', '', '<p><a href="index.php?option=com_content&amp;view=article&amp;id=1&amp;catid=8">текст1</a></p>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 406, '2013-10-20 19:16:27', 406, '2013-10-20 19:48:49', 0, '*'),
(9, 36, 1, 15, 16, 1, 'kategoriya-2', 'com_content', 'Категория 2', 'kategoriya-2', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 406, '2013-10-20 19:16:44', 0, '0000-00-00 00:00:00', 0, '*'),
(10, 37, 1, 17, 18, 1, 'kategoriya-3', 'com_content', 'Категория 3', 'kategoriya-3', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 406, '2013-10-20 19:16:57', 0, '0000-00-00 00:00:00', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_contact_details`
--

CREATE TABLE IF NOT EXISTS `aic0r_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `aic0r_content`
--

CREATE TABLE IF NOT EXISTS `aic0r_content` (
...
--
-- Дамп данных таблицы `aic0r_content`
--

INSERT INTO `aic0r_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 38, 'текст1', 'tekst1', '', '<p>If you''ve been keeping an eye on your cookies, you may have noticed some recent changes GitHub has made to how we track your session. You shouldn''t notice any difference in session behavior (beyond the <a href="https://github.com/blog/1658-view-active-browser-sessions">new ability to revoke sessions</a>), but we''d like to explain what prompted the change.</p>\r\n<p>Replay attacks on stateless session stores have been known and documented for quite some time in <a href="https://github.com/rails/rails/commit/96d610553e5fdaabc923835ab1f194070ddb4477#diff-a3c1c00b37093bdd1716456839cfa620R103">Rails</a> and <a href="https://github.com/django/django/commit/6205a348f084cbab8d2953accecfc04b9fc75543">Django</a>. Using signed cookies for sessions is still incredibly easy to use and scales to high traffic web apps. You just need to understand its limitations. When implementing authentication, simply storing a user ID in the session cookie leaves you open to replay attacks and provides no means for revocation.</p>', '', 1, 0, 0, 8, '2013-10-20 19:22:07', 406, '', '2013-10-20 19:49:30', 406, 0, '0000-00-00 00:00:00', '2013-10-20 19:22:07', '2014-10-31 22:49:20', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 0, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 39, 'текст2', 'tekst2', '', '<h2>Hybrid Cookie Store / DB approach</h2>\r\n<p>After ruling out Rails’ built in method for DB backed sessions, we decided that the concept of user sessions ought to be treated as a first class domain concern. Something with a real application API we can query, test and extend with other app concerns.</p>\r\n<p>The <code>UserSession</code> class is just a normal ActiveRecord class like any other. There''s no excess Rails abstraction layer between it. We''ve extended it with other concerns such as manual revocation, <a href="https://github.com/blog/1513-introducing-github-sudo-mode">sudo mode tracking</a> and data like IP and user agent to help users identify sessions on the <a href="https://github.com/blog/1658-view-active-browser-sessions">active sessions page</a>.</p>', '', 1, 0, 0, 8, '2013-10-20 19:22:45', 406, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-20 19:22:45', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 40, 'текст3', 'tekst3', '', '<p>Staying true to the restful authentication spirit, <code>SessionsController#create</code> creates a new <code>UserSession</code> and <code>SessionsController#destroy</code> deletes it.</p>\r\n<p>A separate cookie called <code>user_session</code> is set referencing the record unique random key. Only signed in users allocate this record. Anonymous traffic to GitHub never creates junk data in our sessions table.</p>\r\n<p>We still have our signed cookie store around as <code>session</code> in our controllers. This handles non-sensitive data like flash notices and multi-step form state. Then we have a separate <code>user_session</code> helper that references the current user’s session record.</p>\r\n<p>This infrastructure change took a few months. For a month, we ran both the old session code path on this new user session path at once. This allowed users to transition over to the new cookie without noticing.</p>\r\n<p>Overall, we are pretty happy with the change. It has made our authentication logic much more clear and explicit. This opens up some new potential now that we have the data on the server.</p>', '', 1, 0, 0, 9, '2013-10-20 19:23:23', 406, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-20 19:23:23', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 1, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 41, 'текст4', 'tekst4', '', '<h2>History on the left-hand side</h2>\r\n<p>Just as we read from left to right, information in apps typically flows from left to right. In the repository view, you’ll now find the list of past commits on the left, and the selected commit to the right.</p>\r\n<h2> </h2>', '', 1, 0, 0, 10, '2013-10-20 19:24:07', 406, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-20 19:24:07', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 1, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(5, 42, 'trsrdst', 'category1', '', '<p>rdggrdgdrggr</p>', '', 1, 0, 0, 8, '2013-10-20 19:50:18', 406, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-10-20 19:50:18', '0000-00-00 00:00:00', '', '', '', 1, 0, 0, '', '', 1, 1, '', 1, '*', '');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `aic0r_content_frontpage` (
...
--
-- Дамп данных таблицы `aic0r_content_frontpage`
--

INSERT INTO `aic0r_content_frontpage` (`content_id`, `ordering`) VALUES
(5, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_content_rating`
--

CREATE TABLE IF NOT EXISTS `aic0r_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `aic0r_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `aic0r_core_log_searches` (
...
--
-- Структура таблицы `aic0r_extensions`
--

CREATE TABLE IF NOT EXISTS `aic0r_extensions` (
...
--
-- Дамп данных таблицы `aic0r_extensions`
--

INSERT INTO `aic0r_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10002, 'DJ-Menu', 'module', 'mod_djmenu', '', 0, 1, 0, 0, '{"legacy":true,"name":"DJ-Menu","type":"module","creationDate":"December 2010","author":"Blue Constant Media LTD","copyright":"Copyright (C) 2010 Blue Constant Media LTD, All rights reserved.","authorEmail":"contact@design-joomla.eu","authorUrl":"http:\\/\\/design-joomla.eu","version":"1.5.0 beta 5","description":"DJ Menu module with mootools effects","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_finder_filters`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_filters` (
...
--
-- Структура таблицы `aic0r_finder_links`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links` (
...
--
-- Структура таблицы `aic0r_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms0` (
...
--
-- Структура таблицы `aic0r_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `aic0r_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `aic0r_finder_taxonomy`
--

INSERT INTO `aic0r_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `aic0r_finder_terms`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_terms` (
...
--
-- Структура таблицы `aic0r_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `aic0r_finder_terms_common`
--

INSERT INTO `aic0r_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `aic0r_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `aic0r_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `aic0r_finder_types`
--

CREATE TABLE IF NOT EXISTS `aic0r_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `aic0r_languages`
--

CREATE TABLE IF NOT EXISTS `aic0r_languages` (
...
--
-- Дамп данных таблицы `aic0r_languages`
--

INSERT INTO `aic0r_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Структура таблицы `aic0r_menu`
--

CREATE TABLE IF NOT EXISTS `aic0r_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `aic0r_menu`
--

INSERT INTO `aic0r_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(4, 'menu', 'com_banners_categories', 'Categories', '', 'Banners/Categories', 'index.php?option=com_categories&extension=com_banners', 'component', 0, 2, 2, 6, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-cat', 0, '', 8, 9, 0, '*', 1),
(5, 'menu', 'com_banners_clients', 'Clients', '', 'Banners/Clients', 'index.php?option=com_banners&view=clients', 'component', 0, 2, 2, 4, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners-clients', 0, '', 10, 11, 0, '*', 1),
...
(7, 'menu', 'com_contact', 'Contacts', '', 'Contacts', 'index.php?option=com_contact', 'component', 0, 1, 1, 8, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 15, 20, 0, '*', 1),
(8, 'menu', 'com_contact', 'Contacts', '', 'Contacts/Contacts', 'index.php?option=com_contact', 'component', 0, 7, 2, 8, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact', 0, '', 16, 17, 0, '*', 1),
(9, 'menu', 'com_contact_categories', 'Categories', '', 'Contacts/Categories', 'index.php?option=com_categories&extension=com_contact', 'component', 0, 7, 2, 6, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:contact-cat', 0, '', 18, 19, 0, '*', 1),
(10, 'menu', 'com_messages', 'Messaging', '', 'Messaging', 'index.php?option=com_messages', 'component', 0, 1, 1, 15, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages', 0, '', 21, 26, 0, '*', 1),
(11, 'menu', 'com_messages_add', 'New Private Message', '', 'Messaging/New Private Message', 'index.php?option=com_messages&task=message.add', 'component', 0, 10, 2, 15, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-add', 0, '', 22, 23, 0, '*', 1),
(12, 'menu', 'com_messages_read', 'Read Private Message', '', 'Messaging/Read Private Message', 'index.php?option=com_messages', 'component', 0, 10, 2, 15, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:messages-read', 0, '', 24, 25, 0, '*', 1),
(13, 'menu', 'com_newsfeeds', 'News Feeds', '', 'News Feeds', 'index.php?option=com_newsfeeds', 'component', 0, 1, 1, 17, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds', 0, '', 27, 32, 0, '*', 1),
(14, 'menu', 'com_newsfeeds_feeds', 'Feeds', '', 'News Feeds/Feeds', 'index.php?option=com_newsfeeds', 'component', 0, 13, 2, 17, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds', 0, '', 28, 29, 0, '*', 1),
(15, 'menu', 'com_newsfeeds_categories', 'Categories', '', 'News Feeds/Categories', 'index.php?option=com_categories&extension=com_newsfeeds', 'component', 0, 13, 2, 6, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:newsfeeds-cat', 0, '', 30, 31, 0, '*', 1),
...
(101, 'mainmenu', 'Главная', 'home', '', 'home', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"layout_type":"blog","num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","multi_column_order":"1","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_pagination_results":"1","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":1,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 1, 4, 1, '*', 0),
(102, 'mainmenu', 'Главная', 'glavnaya', '', 'home/glavnaya', 'index.php?option=com_content&view=category&id=2', 'component', -2, 101, 2, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 3, '{"show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 2, 3, 0, '*', 0),
(104, 'mainmenu', 'Категория 1', 'kategoriya-1', '', 'kategoriya-1', 'index.php?option=com_content&view=category&id=8', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 6, '{"show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 47, 48, 0, '*', 0),
(105, 'mainmenu', 'Категория 2', 'kategoriya-2', '', 'kategoriya-2', 'index.php?option=com_content&view=category&id=9', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 49, 50, 0, '*', 0),
(106, 'mainmenu', 'Категория 3', 'kategoriya-3', '', 'kategoriya-3', 'index.php?option=com_content&view=category&id=10', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 0, '*', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_menu_types`
--

CREATE TABLE IF NOT EXISTS `aic0r_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `aic0r_menu_types`
--

INSERT INTO `aic0r_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Главное меню', 'The main menu for the site'),
(8, 'dj-menu', 'dj-menu', 'dj-menu');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_messages`
--

CREATE TABLE IF NOT EXISTS `aic0r_messages` (
...
--
-- Структура таблицы `aic0r_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `aic0r_messages_cfg` (
...
--
-- Структура таблицы `aic0r_modules`
--

CREATE TABLE IF NOT EXISTS `aic0r_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `aic0r_modules`
--

INSERT INTO `aic0r_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Главное меню', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(87, 'Up', '', '', 1, 'atomic-topmenu', 406, '2013-10-20 20:58:20', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(88, 'DJ-Menu', '', '', 2, 'position-1', 0, '0000-00-00 00:00:00', '2013-10-01 22:34:15', '2015-10-30 22:39:56', -2, 'mod_djmenu', 1, 1, '', 0, '*'),
(92, 'dj-menu', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_djmenu', 1, 1, '', 0, '*'),
(94, 'dj-menu (2)', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_djmenu', 1, 0, '', 0, '*'),
(95, 'usrs', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_users_latest', 1, 0, '{"shownumber":"5","filter_groups":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_modules_menu`
--

CREATE TABLE IF NOT EXISTS `aic0r_modules_menu` (
...
--
-- Дамп данных таблицы `aic0r_modules_menu`
--

INSERT INTO `aic0r_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `aic0r_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `aic0r_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `aic0r_overrider`
--

CREATE TABLE IF NOT EXISTS `aic0r_overrider` (
...
--
-- Структура таблицы `aic0r_redirect_links`
--

CREATE TABLE IF NOT EXISTS `aic0r_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `aic0r_schemas`
--

CREATE TABLE IF NOT EXISTS `aic0r_schemas` (
...
--
-- Дамп данных таблицы `aic0r_schemas`
--

INSERT INTO `aic0r_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.6');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_session`
--

CREATE TABLE IF NOT EXISTS `aic0r_session` (
...
--
-- Дамп данных таблицы `aic0r_session`
--

INSERT INTO `aic0r_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('78ea31725a70d0102668a3d8aec11a17', 1, 0, '1382303828', '__default|a:8:{s:22:"session.client.browser";s:74:"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:21.0) Gecko/20100101 Firefox/21.0";s:15:"session.counter";i:379;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":6:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":6:{s:6:"filter";O:8:"stdClass":4:{s:8:"menutype";s:8:"mainmenu";s:6:"access";i:0;s:5:"level";i:0;s:8:"language";s:0:"";}s:10:"limitstart";i:0;s:6:"search";s:0:"";s:9:"published";s:1:"1";s:8:"ordercol";s:5:"a.lft";s:9:"orderdirn";s:3:"asc";}s:4:"edit";O:8:"stdClass":2:{s:4:"item";O:8:"stdClass":4:{s:2:"id";a:0:{}s:4:"data";N;s:4:"type";N;s:4:"link";N;}s:4:"menu";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:7:"topmenu";}}s:11:"com_modules";O:8:"stdClass":4:{s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:1:{i:0;i:87;}s:4:"data";N;}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:9:"positions";O:8:"stdClass":4:{s:6:"filter";O:8:"stdClass":4:{s:6:"search";s:0:"";s:5:"state";s:0:"";s:8:"template";s:0:"";s:4:"type";s:0:"";}s:10:"limitstart";i:0;s:8:"ordercol";s:5:"value";s:9:"orderdirn";s:3:"asc";}}s:6:"global";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:5:"limit";i:0;}}s:13:"com_installer";O:8:"stdClass":3:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";s:6:"manage";O:8:"stdClass":4:{s:4:"data";a:1:{s:7:"filters";a:5:{s:6:"search";s:0:"";s:9:"client_id";s:0:"";s:6:"status";s:0:"";s:4:"type";s:0:"";s:5:"group";s:0:"";}}s:10:"limitstart";s:1:"0";s:8:"ordercol";s:4:"name";s:9:"orderdirn";s:3:"asc";}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"406";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:16:"bosovsky@ukr.net";s:8:"password";s:65:"dd7d3ac68ee77d3c9975ce47fcf9260c:MZN9lIloz17lSZ1dInoByfpFS6516hq8";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-20 18:01:24";s:13:"lastvisitDate";s:19:"2013-10-20 19:47:37";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"ad6197b2037f70b5c6deba178f32ea99";s:19:"session.timer.start";i:1382300187;s:18:"session.timer.last";i:1382303828;s:17:"session.timer.now";i:1382303828;}', 406, 'admin', ''),
('hgn37k64kgog421o6iciv0i435', 0, 0, '1382303882', '__default|a:9:{s:15:"session.counter";i:69;s:19:"session.timer.start";i:1382300551;s:18:"session.timer.last";i:1382303867;s:17:"session.timer.now";i:1382303882;s:22:"session.client.browser";s:74:"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:21.0) Gecko/20100101 Firefox/21.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:6:"return";s:20:"index.php?Itemid=106";s:4:"data";a:0:{}}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"406";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:16:"bosovsky@ukr.net";s:8:"password";s:65:"dd7d3ac68ee77d3c9975ce47fcf9260c:MZN9lIloz17lSZ1dInoByfpFS6516hq8";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-20 18:01:24";s:13:"lastvisitDate";s:19:"2013-10-20 20:22:31";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:3:{s:40:"f01b475b45640549dc3b61c5a295eaf8e221f406";O:8:"stdClass":2:{s:4:"link";s:51:"http://homework2/index.php/kategoriya-1/5-category1";s:6:"expiry";i:1382303716;}s:40:"828d63f990795c5413de90f73e6b088107df8a07";O:8:"stdClass":2:{s:4:"link";s:43:"http://homework2/index.php/vyvv/5-category1";s:6:"expiry";i:1382302562;}s:40:"0c056482c108f47b71a1540600f54c73074dbc0d";O:8:"stdClass":2:{s:4:"link";s:41:"http://homework2/index.php/up/5-category1";s:6:"expiry";i:1382303225;}}s:13:"session.token";s:32:"e3f8f695d9bea1fd4b471bdf8a766a78";}', 406, 'admin', '');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_template_styles`
--

CREATE TABLE IF NOT EXISTS `aic0r_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `aic0r_template_styles`
--

INSERT INTO `aic0r_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `aic0r_updates`
--

CREATE TABLE IF NOT EXISTS `aic0r_updates` (
...
--
-- Дамп данных таблицы `aic0r_updates`
--

INSERT INTO `aic0r_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
(1, 1, 700, 0, 'Joomla', '', 'joomla', 'file', '', 0, '2.5.14', '', 'http://update.joomla.org/core/extension.xml', '');

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_update_categories`
--

CREATE TABLE IF NOT EXISTS `aic0r_update_categories` (
...
--
-- Структура таблицы `aic0r_update_sites`
--

CREATE TABLE IF NOT EXISTS `aic0r_update_sites` (
...
--
-- Дамп данных таблицы `aic0r_update_sites`
--

INSERT INTO `aic0r_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1382292097),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1382292097);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `aic0r_update_sites_extensions` (
...
--
-- Дамп данных таблицы `aic0r_update_sites_extensions`
--

INSERT INTO `aic0r_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700);
...
--
-- Структура таблицы `aic0r_usergroups`
--

CREATE TABLE IF NOT EXISTS `aic0r_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `aic0r_usergroups`
--

INSERT INTO `aic0r_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Все'),
...
--
-- Структура таблицы `aic0r_users`
--

CREATE TABLE IF NOT EXISTS `aic0r_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `aic0r_users`
--

INSERT INTO `aic0r_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(406, 'Super User', 'admin', 'bosovsky@ukr.net', 'dd7d3ac68ee77d3c9975ce47fcf9260c:MZN9lIloz17lSZ1dInoByfpFS6516hq8', 'deprecated', 0, 1, '2013-10-20 18:01:24', '2013-10-20 21:16:45', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_user_notes`
--

CREATE TABLE IF NOT EXISTS `aic0r_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `aic0r_user_profiles`
--

CREATE TABLE IF NOT EXISTS `aic0r_user_profiles` (
...
--
-- Структура таблицы `aic0r_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `aic0r_user_usergroup_map` (
...
--
-- Дамп данных таблицы `aic0r_user_usergroup_map`
--

INSERT INTO `aic0r_user_usergroup_map` (`user_id`, `group_id`) VALUES
(406, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `aic0r_viewlevels`
--

CREATE TABLE IF NOT EXISTS `aic0r_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `aic0r_viewlevels`
--

INSERT INTO `aic0r_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Для всех', 0, '[1]'),
...
--
-- Структура таблицы `aic0r_weblinks`
--

CREATE TABLE IF NOT EXISTS `aic0r_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
